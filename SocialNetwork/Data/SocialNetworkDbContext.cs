...
namespace SocialNetwork.Data
{
    ...
    {
        private const string ConnectionString = @"Server=DESKTOP-E6E3TVC\SQLEXPRESS;Database=SocialNetworkDb;Trusted_Connection=True;Encrypt=False";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Friendship>().HasOne(f => f.UserOne)
                .WithMany()
                .HasForeignKey(f => f.UserOneId)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<Friendship>().HasOne(u =>  u.UserTwo)
                .WithMany()
            ...
            modelBuilder.Entity<UserConversation>().HasKey(uc => new
            {
                uc.UserId,
                uc.ConversationId
            });
